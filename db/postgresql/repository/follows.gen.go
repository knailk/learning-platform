...
type IFollowDo interface {
	...
	Unscoped() IFollowDo
	Create(values ...*models.Follow) error
	CreateInBatches(values []*models.Follow, batchSize int) error
	Save(values ...*models.Follow) error
	First() (*models.Follow, error)
	Take() (*models.Follow, error)
	Last() (*models.Follow, error)
	Find() ([]*models.Follow, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Follow, err error)
	FindInBatches(result *[]*models.Follow, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*models.Follow) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*models.Follow, error)
	FirstOrCreate() (*models.Follow, error)
	FindByPage(offset int, limit int) (result []*models.Follow, count int64, err error)
