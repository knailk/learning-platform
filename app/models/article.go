...
// Create ...
func (m ArticleModel) Create(userID int64, form request.CreateArticleRequest) (articleID int64, err error) {
...
// Update ...
func (m ArticleModel) Update(userID int64, id int64, form request.CreateArticleRequest) (err error) {
	//METHOD 1
