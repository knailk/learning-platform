...
// Create ...
func (m ArticleModel) Create(userID int64, form request.CreateArticleForm) (articleID int64, err error) {
...
// Update ...
func (m ArticleModel) Update(userID int64, id int64, form request.CreateArticleForm) (err error) {
	//METHOD 1
